...
#    print(predictions)
    predictions = read_naacl_alignments(testfile)
...
#    test('validation/dev.wa.nonullalign','checking_val_naacl.txt')
    
    
#    AERscore_ibm1 = []
#    for i in range(10):
#        testfile =  "val_naacl_IBM1_iter" + str(i)+ ".txt"    
#        result = test('validation/dev.wa.nonullalign',testfile)
#        AERscore_ibm1.append(result)
    
    test('testing/answers/test.wa.nonullalign','naacl-testtransprobs_9')
